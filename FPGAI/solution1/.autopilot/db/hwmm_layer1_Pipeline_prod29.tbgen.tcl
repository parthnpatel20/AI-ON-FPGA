set moduleName hwmm_layer1_Pipeline_prod29
set isTopModule 0
...
set C_modelName {hwmm_layer1_Pipeline_prod29}
set C_modelType { void 0 }
set C_modelArgList {
	{ input_img int 32 regular {array 100 { 1 3 } 1 1 }  }
	{ sum_52_out float 32 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "input_img", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "sum_52_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ sum_52_out sc_out sc_lv 32 signal 1 } 
	{ sum_52_out_ap_vld sc_out sc_logic 1 outvld 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sum_52_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "sum_52_out", "role": "default" }} , 
 	{ "name": "sum_52_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "sum_52_out", "role": "ap_vld" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.layer1_weights_26_U", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	sum_52_out { ap_vld {  { sum_52_out out_data 1 32 }  { sum_52_out_ap_vld out_vld 1 1 } } }
}
