set moduleName nn_inference_Pipeline_3
set isTopModule 0
...
set C_modelName {nn_inference_Pipeline_3}
...
set portList { 
	...
	{ temp_output3_0_we0 sc_out sc_logic 1 signal 0 } 
	{ temp_output3_0_d0 sc_out sc_lv 32 signal 0 } 
}
set NewPortList {[ 
