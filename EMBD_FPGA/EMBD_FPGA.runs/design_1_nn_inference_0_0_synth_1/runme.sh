...
HD_PWD='D:/University_of_Colorado_Boulder/Fall2025/Embedded_AI/Prj/EMBD_FPGA/EMBD_FPGA.runs/design_1_nn_inference_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_nn_inference_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_nn_inference_0_0.tcl
